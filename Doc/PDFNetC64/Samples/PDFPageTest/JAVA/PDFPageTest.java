    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 1; i <= page_num; ++i) {
                ...
                new_doc.save(output_path + "newsletter_split_page_" + i + ".pdf", SDFDoc.SaveMode.REMOVE_UNUSED, null);
                // output PDF new_doc
        ...
        try {
            ...
            for (int i = 1; i <= page_num; ++i) {
                ...
                PDFDoc in_doc = new PDFDoc(output_path + "newsletter_split_page_" + i + ".pdf");
