...
void AnnotationHighLevelAPI(PDFDoc& doc)
{
	...
	Annot::BorderStyle border_style(Annot::BorderStyle::e_solid, 3, 0, 0);
	...
	Annots::FileAttachment file_attach = Annots::FileAttachment::Create(doc, Rect(80, 280, 200, 320), (input_path + "peppers.jpg").c_str());
	...
	//Annots::Polygon poly2=Annots::Polygon::Create(doc, Rect(100, 60, 300, 480));
	//Point pllp;
	//pllp.x=105;
	//pllp.y=68;
